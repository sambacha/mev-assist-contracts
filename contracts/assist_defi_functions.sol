...
contract AssistContract_total_functions is
    Ownable,
    DSMath,
    FlashLoanReceiverBase(address(0x24a42fD28C976A61Df5D00D0599C34c4f90748c8))
{
    ...
    uint256 public cethBal;
    uint256 public exchangeRate;
    uint256 public cethInEth;
...
//////////////////////////////////////////////*/
    ...
    function assist_dydx_flash(uint256 _amount) public payable {
        ...
        uint256 borrow_amount = _amount * 3;
        uint256 repay_amount = borrow_amount + 2;

        SoloMargin.AccountInfo[] memory accounts =
            new SoloMargin.AccountInfo[](1);
    ...
    function assist_dydx_deposit(uint256 _amount) public payable {
        WETH9 weth = WETH9(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
        weth.deposit.value(_amount)();
    ...
    function assist_dydx_withdraw(uint256 _amount, uint256 _margin)
        public
        payable
    {
        IERC20 token = IERC20(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
        ...
        soloMargin.operate(accounts, actions);
        token.transfer(
            0x0E63f9250cF0aFE739035F2539a8435078006802,
            token.balanceOf(address(this))
        );
    }

    function assist_dydx_callfunction(uint256 _amount) public payable {
        SoloMargin soloMargin =
            SoloMargin(0x1E0447b19BB6EcFdAe1e4AE1694b0C3659614e4e);
...
//////////////////////////////////////////////*/
    ...
    function assist_compound_open(uint256 _amount) public payable {
        ...
        PriceOracle oracle =
            PriceOracle(0xdA17fbEdA95222f331Cb1D252401F4b44F49f7A0);
    ...
    function assist_compound_repay(uint256 _amount) public payable {
        setApproval(
        ...
        dai.approve(0x5d3a536E4D6DbD6114cc1Ead35777bAB948E3643, uint256(-1));
        cDai.repayBorrow(_amount);
    }

    function assist_compound_redeem(uint256 _amount) public payable {
        CTokenInterface cToken =
            CTokenInterface(0x4Ddc2D193948926D02f9B1fE9e1daa0718270ED5);
    ...
    2.dai to eth
//////////////////////////////////////////////*/
    function assist_kyber_buy(uint256 _amount) public payable {
        ...
        uint256 destAmount1 =
            kyberNetworkProxyContract.swapEtherToToken.value(_amount)(
                DAI_TOKEN_ADDRESS,
                minConversionRate
            );
    ...
    function assist_kyber_rollback(uint256 _amount) public payable {
        uint256 minConversionRate1;
        IERC20 token = IERC20(DAI_TOKEN_ADDRESS);
        token.approve(0x818E6FECD516Ecc3849DAf6845e3EC868087B755, uint256(-1));
        (minConversionRate1, ) = kyberNetworkProxyContract.getExpectedRate(
            DAI_TOKEN_ADDRESS,
            ETH_TOKEN_ADDRESS,
            IERC20(DAI_TOKEN_ADDRESS).balanceOf(address(this))
        );
        uint256 destAmount2 =
            kyberNetworkProxyContract.swapTokenToEther(
                DAI_TOKEN_ADDRESS,
                IERC20(DAI_TOKEN_ADDRESS).balanceOf(address(this)),
                minConversionRate1
            );
...
//////////////////////////////////////////////*/
    ...
    function assist_uniswap_drop(uint256 _amount) public payable {
        ...
        uint256 Returned =
            toExchange.ethToTokenSwapInput.value(_amount)(1, now);

        ERC20 dai = ERC20(0x6B175474E89094C44Da98b954EedeAC495271d0F);
        dai.approve(uniswapExchangeAddress, uint256(-1));
        dai.approve(0xc0a47dFe034B400B47bDaD5FecDa2621de6c4d95, uint256(-1));
        //toExchange.tokenToEthSwapInput(_amount, 1, now);
    }

    function assist_uniswap_sell(uint256 _amount) public payable {
        IUniswapFactory uniswapFactory =
            IUniswapFactory(0xc0a47dFe034B400B47bDaD5FecDa2621de6c4d95);
        address uniswapExchangeAddress =
            uniswapFactory.getExchange(
...
//////////////////////////////////////////////*/
    ...
    function assist_bzx() public onlyOwner {
    ...
    function assist_bzx1() public onlyOwner {
        ...
        fulcrumInterface margin =
            fulcrumInterface(0x9fC208947d92B1588F7BdE245620439568A8587a);
        uint256 maxPrice = 100000000000000000000000000;
        uint256 tokensIssued =
            margin.mintWithEther.value(100 * 1e14)(
  ...
  //////////////////////////////////////////////*/
    ...
    function assist_icurve() public onlyOwner {
        address swap = 0x45F783CCE6B7FF23B2ab2D70e416cdb7D6055f51;
        address dai = address(0x6B175474E89094C44Da98b954EedeAC495271d0F);
        address usdc = address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);

        IERC20 token1 = IERC20(dai);
        token1.approve(swap, uint256(-1));

        IERC20 token2 = IERC20(usdc);
        token2.approve(swap, uint256(-1));

        ICurveFi(swap).exchange_underlying(
            0,
            1,
...
//////////////////////////////////////////////*/
    ...
    function assist_apporve(address _tokens, address _approver)
        public
        onlyOwner
    {
        IERC20 token = IERC20(_tokens);
        token.approve(_approver, uint256(-1));
    }

    function withdraw(address _tokens, address _approver) public onlyOwner {
        IERC20 token = IERC20(_tokens);
        token.approve(_approver, uint256(-1));
